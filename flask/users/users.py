...
@login_required
def python():
    python = Techademy.query.filter_by(category="python")
...
@login_required
def github():
    github = Techademy.query.filter_by(category="github")
...
@login_required
def java():
    javascript = Techademy.query.filter_by(category="javascript")
    return render_template("java.html", javascript=javascript, title="JavaScript")
